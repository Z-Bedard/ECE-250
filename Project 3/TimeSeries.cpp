...
double TimeSeries::mean(TimeSeries &ArrayIn, bool &valid) { //Take in the whole object
    ...
    valid = foundValid;
    mean = sum / ArrayIn.get_size(); //Calculate mean
    return mean;
}
